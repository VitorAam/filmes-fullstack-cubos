...
type RetrieveAccountData = z.infer<typeof schema>;

export default function LoginPage() {
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<RetrieveAccountData>({
  ...
  const onSubmit = async (data: RetrieveAccountData) => {
    try {
